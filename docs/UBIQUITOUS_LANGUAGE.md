...
| **Local Path Semantics** | Explicit portable policy for local absolute paths, home-relative spelling, directory display, completion boundaries, and file-URL conversion, selected by Host Composition and retained by Local Filesystem Authority. | ambient host detection, slash-only UI parsing |
