...
mod native {
    ...
    use super::{
        AccessibilityElementState, AccessibilityNotification, AccessibilityNotifications,
...
#[cfg(any(not(target_os = "macos"), test))]
impl MacosAccessibilityElement {
    pub(crate) fn new(_: &gpui::Window, model: TerminalAccessibilityModel) -> Self {
        Self {
            model,
            presented: false,
            visible: false,
    ...
    pub(crate) fn update(
        ...
        let _ = (update.window, update.cell_width, update.line_height);
