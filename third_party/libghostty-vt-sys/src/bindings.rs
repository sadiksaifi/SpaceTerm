...
pub mod AccessibilityScreen {
    pub type Type = ::std::os::raw::c_uint;
    pub const PRIMARY: Type = 0;
    pub const ALTERNATE: Type = 1;
}
pub mod AccessibilityCellWide {
    pub type Type = ::std::os::raw::c_uint;
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct AccessibilityRowId {
    pub screen: AccessibilityScreen::Type,
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of AccessibilityRowId"][::std::mem::size_of::<AccessibilityRowId>() - 32usize];
    ["Alignment of AccessibilityRowId"][::std::mem::align_of::<AccessibilityRowId>() - 8usize];
    ["Offset of field: AccessibilityRowId::screen"]
        [::std::mem::offset_of!(AccessibilityRowId, screen) - 0usize];
    ["Offset of field: AccessibilityRowId::screen_generation"]
        [::std::mem::offset_of!(AccessibilityRowId, screen_generation) - 8usize];
    ["Offset of field: AccessibilityRowId::node_serial"]
        [::std::mem::offset_of!(AccessibilityRowId, node_serial) - 16usize];
    ["Offset of field: AccessibilityRowId::page_row"]
        [::std::mem::offset_of!(AccessibilityRowId, page_row) - 24usize];
};
impl Default for AccessibilityRowId {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct AccessibilityCellRef {
    pub row: AccessibilityRowId,
    pub row_revision: u64,
    pub column: u16,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of AccessibilityCellRef"][::std::mem::size_of::<AccessibilityCellRef>() - 48usize];
    ["Alignment of AccessibilityCellRef"][::std::mem::align_of::<AccessibilityCellRef>() - 8usize];
    ["Offset of field: AccessibilityCellRef::row"]
        [::std::mem::offset_of!(AccessibilityCellRef, row) - 0usize];
    ["Offset of field: AccessibilityCellRef::row_revision"]
        [::std::mem::offset_of!(AccessibilityCellRef, row_revision) - 32usize];
    ["Offset of field: AccessibilityCellRef::column"]
        [::std::mem::offset_of!(AccessibilityCellRef, column) - 40usize];
};
impl Default for AccessibilityCellRef {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct AccessibilityUpdateOptions {
    pub size: usize,
    pub max_cells: usize,
    pub max_rows: usize,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of AccessibilityUpdateOptions"]
        [::std::mem::size_of::<AccessibilityUpdateOptions>() - 24usize];
    ["Alignment of AccessibilityUpdateOptions"]
        [::std::mem::align_of::<AccessibilityUpdateOptions>() - 8usize];
    ["Offset of field: AccessibilityUpdateOptions::size"]
        [::std::mem::offset_of!(AccessibilityUpdateOptions, size) - 0usize];
    ["Offset of field: AccessibilityUpdateOptions::max_cells"]
        [::std::mem::offset_of!(AccessibilityUpdateOptions, max_cells) - 8usize];
    ["Offset of field: AccessibilityUpdateOptions::max_rows"]
        [::std::mem::offset_of!(AccessibilityUpdateOptions, max_rows) - 16usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct AccessibilitySnapshot {
    ...
    pub has_cursor: bool,
    pub cursor: AccessibilityCellRef,
    pub has_selection: bool,
    pub selection_start: AccessibilityCellRef,
    pub selection_end: AccessibilityCellRef,
    pub selection_rectangle: bool,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of AccessibilitySnapshot"][::std::mem::size_of::<AccessibilitySnapshot>() - 240usize];
    ["Alignment of AccessibilitySnapshot"]
        [::std::mem::align_of::<AccessibilitySnapshot>() - 8usize];
    ["Offset of field: AccessibilitySnapshot::size"]
        [::std::mem::offset_of!(AccessibilitySnapshot, size) - 0usize];
    ["Offset of field: AccessibilitySnapshot::revision"]
        [::std::mem::offset_of!(AccessibilitySnapshot, revision) - 8usize];
    ["Offset of field: AccessibilitySnapshot::screen"]
        [::std::mem::offset_of!(AccessibilitySnapshot, screen) - 16usize];
    ["Offset of field: AccessibilitySnapshot::screen_generation"]
        [::std::mem::offset_of!(AccessibilitySnapshot, screen_generation) - 24usize];
    ["Offset of field: AccessibilitySnapshot::complete"]
        [::std::mem::offset_of!(AccessibilitySnapshot, complete) - 32usize];
    ["Offset of field: AccessibilitySnapshot::more"]
        [::std::mem::offset_of!(AccessibilitySnapshot, more) - 33usize];
    ["Offset of field: AccessibilitySnapshot::topology_changed"]
        [::std::mem::offset_of!(AccessibilitySnapshot, topology_changed) - 34usize];
    ["Offset of field: AccessibilitySnapshot::topology_epoch"]
        [::std::mem::offset_of!(AccessibilitySnapshot, topology_epoch) - 40usize];
    ["Offset of field: AccessibilitySnapshot::topology_complete"]
        [::std::mem::offset_of!(AccessibilitySnapshot, topology_complete) - 48usize];
    ["Offset of field: AccessibilitySnapshot::visible_start"]
        [::std::mem::offset_of!(AccessibilitySnapshot, visible_start) - 56usize];
    ["Offset of field: AccessibilitySnapshot::visible_len"]
        [::std::mem::offset_of!(AccessibilitySnapshot, visible_len) - 64usize];
    ["Offset of field: AccessibilitySnapshot::has_cursor"]
        [::std::mem::offset_of!(AccessibilitySnapshot, has_cursor) - 72usize];
    ["Offset of field: AccessibilitySnapshot::cursor"]
        [::std::mem::offset_of!(AccessibilitySnapshot, cursor) - 80usize];
    ["Offset of field: AccessibilitySnapshot::has_selection"]
        [::std::mem::offset_of!(AccessibilitySnapshot, has_selection) - 128usize];
    ["Offset of field: AccessibilitySnapshot::selection_start"]
        [::std::mem::offset_of!(AccessibilitySnapshot, selection_start) - 136usize];
    ["Offset of field: AccessibilitySnapshot::selection_end"]
        [::std::mem::offset_of!(AccessibilitySnapshot, selection_end) - 184usize];
    ["Offset of field: AccessibilitySnapshot::selection_rectangle"]
        [::std::mem::offset_of!(AccessibilitySnapshot, selection_rectangle) - 232usize];
};
...
pub struct AccessibilityRow {
    pub id: AccessibilityRowId,
    pub revision: u64,
    pub soft_wrapped: bool,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of AccessibilityRow"][::std::mem::size_of::<AccessibilityRow>() - 48usize];
    ["Alignment of AccessibilityRow"][::std::mem::align_of::<AccessibilityRow>() - 8usize];
    ["Offset of field: AccessibilityRow::id"]
        [::std::mem::offset_of!(AccessibilityRow, id) - 0usize];
    ["Offset of field: AccessibilityRow::revision"]
        [::std::mem::offset_of!(AccessibilityRow, revision) - 32usize];
    ["Offset of field: AccessibilityRow::soft_wrapped"]
        [::std::mem::offset_of!(AccessibilityRow, soft_wrapped) - 40usize];
};
impl Default for AccessibilityRow {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
pub struct AccessibilityCell {
    pub column: u16,
    pub wide: AccessibilityCellWide::Type,
    pub codepoint: u32,
    pub extra_codepoints: *const u32,
    pub extra_codepoints_len: usize,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of AccessibilityCell"][::std::mem::size_of::<AccessibilityCell>() - 32usize];
    ["Alignment of AccessibilityCell"][::std::mem::align_of::<AccessibilityCell>() - 8usize];
    ["Offset of field: AccessibilityCell::column"]
        [::std::mem::offset_of!(AccessibilityCell, column) - 0usize];
    ["Offset of field: AccessibilityCell::wide"]
        [::std::mem::offset_of!(AccessibilityCell, wide) - 4usize];
    ["Offset of field: AccessibilityCell::codepoint"]
        [::std::mem::offset_of!(AccessibilityCell, codepoint) - 8usize];
    ["Offset of field: AccessibilityCell::extra_codepoints"]
        [::std::mem::offset_of!(AccessibilityCell, extra_codepoints) - 16usize];
    ["Offset of field: AccessibilityCell::extra_codepoints_len"]
        [::std::mem::offset_of!(AccessibilityCell, extra_codepoints_len) - 24usize];
};
impl Default for AccessibilityCell {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
pub type AccessibilityTopologyCallback = ::std::option::Option<
    unsafe extern "C" fn(
        userdata: *mut ::std::os::raw::c_void,
        row: *const AccessibilityRowId,
    ) -> bool,
>;
pub type AccessibilityRowCallback = ::std::option::Option<
    unsafe extern "C" fn(
        userdata: *mut ::std::os::raw::c_void,
        row: *const AccessibilityRow,
    ) -> bool,
>;
pub type AccessibilityCellCallback = ::std::option::Option<
    unsafe extern "C" fn(
        userdata: *mut ::std::os::raw::c_void,
        cell: *const AccessibilityCell,
    ) -> bool,
>;
unsafe extern "C" {
    #[doc = " Create persistent incremental accessibility state.\n\n The state is independent of a terminal, is not thread-safe, and must be\n freed with ghostty_accessibility_state_free."]
    pub fn ghostty_accessibility_state_new(out_state: *mut *mut AccessibilityState)
    -> Result::Type;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn ghostty_accessibility_state_update(
        ...
        terminal: Terminal,
        options: *const AccessibilityUpdateOptions,
        userdata: *mut ::std::os::raw::c_void,
        topology_callback: AccessibilityTopologyCallback,
        row_callback: AccessibilityRowCallback,
        cell_callback: AccessibilityCellCallback,
        out_snapshot: *mut AccessibilitySnapshot,
    ) -> Result::Type;
}
unsafe extern "C" {
    #[doc = " Replace or clear the active terminal selection.\n\n Non-NULL endpoints must name the active screen generation and exact current\n row revisions from a complete snapshot. A stale request succeeds with\n out_changed=false and does not mutate the terminal."]
    pub fn ghostty_accessibility_state_set_selection(
        state: *mut AccessibilityState,
        terminal: Terminal,
        start: *const AccessibilityCellRef,
        end: *const AccessibilityCellRef,
...
unsafe extern "C" {
    #[doc = " Get opaque application metadata retained with the cell's hyperlink.\n\n If the cell has no hyperlink, all values are set to zero. This metadata is\n never included in terminal text or formatter output."]
...
#[doc = " Fully resolved render geometry for a normal or Unicode-placeholder placement."]
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct KittyGraphicsResolvedPlacement {
    pub size: usize,
    pub image_id: u32,
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of KittyGraphicsResolvedPlacement"]
        [::std::mem::size_of::<KittyGraphicsResolvedPlacement>() - 64usize];
    ["Alignment of KittyGraphicsResolvedPlacement"]
        [::std::mem::align_of::<KittyGraphicsResolvedPlacement>() - 8usize];
    ["Offset of field: KittyGraphicsResolvedPlacement::size"]
        [::std::mem::offset_of!(KittyGraphicsResolvedPlacement, size) - 0usize];
    ["Offset of field: KittyGraphicsResolvedPlacement::image_id"]
        [::std::mem::offset_of!(KittyGraphicsResolvedPlacement, image_id) - 8usize];
    ["Offset of field: KittyGraphicsResolvedPlacement::placement_id"]
        [::std::mem::offset_of!(KittyGraphicsResolvedPlacement, placement_id) - 12usize];
    ["Offset of field: KittyGraphicsResolvedPlacement::z"]
        [::std::mem::offset_of!(KittyGraphicsResolvedPlacement, z) - 16usize];
    ["Offset of field: KittyGraphicsResolvedPlacement::viewport_col"]
        [::std::mem::offset_of!(KittyGraphicsResolvedPlacement, viewport_col) - 20usize];
    ["Offset of field: KittyGraphicsResolvedPlacement::viewport_row"]
        [::std::mem::offset_of!(KittyGraphicsResolvedPlacement, viewport_row) - 24usize];
    ["Offset of field: KittyGraphicsResolvedPlacement::cell_offset_x"]
        [::std::mem::offset_of!(KittyGraphicsResolvedPlacement, cell_offset_x) - 28usize];
    ["Offset of field: KittyGraphicsResolvedPlacement::cell_offset_y"]
        [::std::mem::offset_of!(KittyGraphicsResolvedPlacement, cell_offset_y) - 32usize];
    ["Offset of field: KittyGraphicsResolvedPlacement::source_x"]
        [::std::mem::offset_of!(KittyGraphicsResolvedPlacement, source_x) - 36usize];
    ["Offset of field: KittyGraphicsResolvedPlacement::source_y"]
        [::std::mem::offset_of!(KittyGraphicsResolvedPlacement, source_y) - 40usize];
    ["Offset of field: KittyGraphicsResolvedPlacement::source_width"]
        [::std::mem::offset_of!(KittyGraphicsResolvedPlacement, source_width) - 44usize];
    ["Offset of field: KittyGraphicsResolvedPlacement::source_height"]
        [::std::mem::offset_of!(KittyGraphicsResolvedPlacement, source_height) - 48usize];
    ["Offset of field: KittyGraphicsResolvedPlacement::dest_width"]
        [::std::mem::offset_of!(KittyGraphicsResolvedPlacement, dest_width) - 52usize];
    ["Offset of field: KittyGraphicsResolvedPlacement::dest_height"]
        [::std::mem::offset_of!(KittyGraphicsResolvedPlacement, dest_height) - 56usize];
    ["Offset of field: KittyGraphicsResolvedPlacement::is_virtual"]
        [::std::mem::offset_of!(KittyGraphicsResolvedPlacement, is_virtual) - 60usize];
};
#[doc = " Return false to stop visiting placements."]
pub type KittyGraphicsResolvedPlacementCallback = ::std::option::Option<
    unsafe extern "C" fn(
        userdata: *mut ::std::os::raw::c_void,
        placement: *const KittyGraphicsResolvedPlacement,
    ) -> bool,
>;
unsafe extern "C" {
...
unsafe extern "C" {
    #[doc = " Visit every visible Kitty placement with renderer-ready geometry.\n This includes placements resolved from U+10EEEE placeholder cells.\n All pointers are borrowed and valid only for the duration of this call."]
    pub fn ghostty_terminal_kitty_graphics_resolved_placements(
        terminal: Terminal,
        userdata: *mut ::std::os::raw::c_void,
        callback: KittyGraphicsResolvedPlacementCallback,
    ) -> Result::Type;
}
unsafe extern "C" {
    #[doc = " Advance frames using a monotonic millisecond timestamp. NO_VALUE means no next deadline."]
    pub fn ghostty_terminal_kitty_graphics_animation_tick(
        terminal: Terminal,
        now_ms: u64,
        delay_ms: *mut u64,
    ) -> Result::Type;
...
unsafe extern "C" {
    #[doc = " Write payload usage in primary, alternate screen order into a two-element array."]
    pub fn ghostty_terminal_kitty_graphics_storage_bytes(
        terminal: Terminal,
        bytes: *mut usize,
    ) -> Result::Type;
}
unsafe extern "C" {
    #[doc = " Set independent limits on both initialized screens."]
    pub fn ghostty_terminal_kitty_graphics_storage_limits(
        terminal: Terminal,
        primary: usize,
        alternate: usize,
    ) -> Result::Type;
...
pub mod HyperlinkResolution {
    #[doc = " Result of resolving an accepted OSC 8 hyperlink URI."]
    pub type Type = ::std::os::raw::c_int;
...
#[doc = " Resolves one semantically accepted OSC 8 hyperlink start. URI bytes are\n borrowed for the callback duration. For REPLACE, write replacement bytes and\n optional opaque userdata to library-owned output storage. The bytes and\n userdata are copied into the screen before semantic dispatch returns. The\n callback must not retain either pointer or re-enter this terminal."]
...
>;
#[doc = " Observes one semantically accepted OSC 133 command."]
...
pub mod TerminalOption {
    ...
    #[doc = " SpaceTerm extension: Input type GhosttyTerminalHyperlinkResolveFn."]
    pub const HYPERLINK_RESOLVE: Type = 1000;
    #[doc = " SpaceTerm extension: Input type GhosttyTerminalSemanticPromptFn."]
    pub const SEMANTIC_PROMPT: Type = 1001;
    #[doc = " SpaceTerm extension: Input type GhosttyTerminalSemanticPromptFn."]
    pub const MAX_VALUE: Type = 2147483647;
}
