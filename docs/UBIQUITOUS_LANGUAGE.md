...
- **Finder Fallback** completion requires its exact picker lifecycle and operation identity. Cancellation preserves picker state; a successful selection enters the existing shared validation path; a stale completion cannot settle a successor request.
