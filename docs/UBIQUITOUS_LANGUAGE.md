...
- Local-file emission metadata is a versioned opaque token with no path or native identity fields. One **Terminal Emulator** retains at most 1024 emitted leases and releases them on teardown; unknown, foreign, malformed, oversized, or evicted tokens are inert. A retained typed target cannot authorize a replacement object.
